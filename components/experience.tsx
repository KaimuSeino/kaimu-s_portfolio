        ...
        <div id="experience" className="w-full">
            ...
            <div className="flex flex-col md:flex-row items-center justify-around">
              ...
              <div className="w-full my-4 md:w-[500px]">
                ...
                ビジョンを描き、プロダクトを考え、ピッチをするプログラムを行い
                ました。最終ピッチでは、Nstockの宮田さんと高橋さんにピッチを
                行いました。
              </div>
            </div>
            <div className="flex flex-col md:flex-row items-center justify-around">
              ...
              <div className="w-full my-4 md:w-[500px]">
                アクセラレータプログラムに参加しビジネスプランの構築・成果報告を行いました。<br />
                チームで新規事業を立案し、webアプリケーションの開発を行い、想定ユーザーにデモを使用してもらいフィードバックをいただき、成果報告会を行うことができました。<br />
              </div>
            </div>
            <div className="flex flex-col md:flex-row items-center justify-around">
              <div className="w-full md:w-[300px]">
